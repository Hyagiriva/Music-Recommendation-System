...
client_credentials_manager = SpotifyClientCredentials(client_id='97cf9c71eef34d97b3712120ccdd9716', client_secret='9680c1e87f484a728faa8eb12dad7a80')
...
image = Image.open('C:/Users/Hyagiriva/mini project/code/images/musicback.jpg')
python_image = ImageTk.PhotoImage(image)
l = tk.Label(root, image=python_image)
l.image = python_image  # just keeping a reference
l.grid()
...
sub_btn.grid(column=0, row=0,sticky=tk.E, padx=5, pady=5)
...
image1 = Image.open("C:/Users/Hyagiriva/mini project/code/images/musicimg.jpg")
